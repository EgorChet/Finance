...
import { budgetSpendBreakdown, moneyLeft } from "@/features/household/utils/householdBudget";
...
import { livingBudgetForMonth } from "@/features/household/utils/livingBudget";
import { formatAboutIls, formatIls, formatIlsWhole, roundMoney } from "@/shared/utils/format";
import { getCycleRangeForStart, type PaceAvgCycles } from "@/features/spending/utils/pace";
...
export function paceInjectionCushionVerdict(ctx: PaceBudgetContext): {
  ...
  const spentVsLast = ctx.spentVsLastCycleAtDay;
